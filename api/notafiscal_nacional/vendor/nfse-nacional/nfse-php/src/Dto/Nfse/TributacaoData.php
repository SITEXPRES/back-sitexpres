...
class TributacaoData extends DataTransferObject
{
    ...
    public ?float $aliquotaIssqn = null;

    /**
     * Regime de apuração do ISSQN.
     */
    #[MapFrom('tribMun.regApTribISSQN'), CastWith(EnumCaster::class, enumType: RegimeApuracaoSN::class)]
    public ?RegimeApuracaoSN $regimeApuracaoTributoIssqn = null;
