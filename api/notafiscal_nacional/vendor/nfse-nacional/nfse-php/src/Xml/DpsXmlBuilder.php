    ...
    private function buildValores(DOMElement $parent, ValoresData $data): void
    {
        ...
        if ($data->valorServicoPrestado) {
            ...
            $this->appendElement(
                $vServPrest,
                'vReceb',
                $data->valorServicoPrestado->valorRecebido !== null
                ? number_format($data->valorServicoPrestado->valorRecebido, 2, '.', '')
                : null
            );
            ...
            $this->appendElement(
                $vServPrest,
                'vServ',
                $data->valorServicoPrestado->valorServico !== null
                ? number_format($data->valorServicoPrestado->valorServico, 2, '.', '')
                : null
            );
        ...
        if ($data->desconto) {
            ...
            $this->appendElement(
                $vDesc,
                'vDescIncond',
                $data->desconto->valorDescontoIncondicionado !== null
                ? number_format($data->desconto->valorDescontoIncondicionado, 2, '.', '')
                : null
            );
            ...
            $this->appendElement(
                $vDesc,
                'vDescCond',
                $data->desconto->valorDescontoCondicionado !== null
                ? number_format($data->desconto->valorDescontoCondicionado, 2, '.', '')
                : null
            );
        ...
        if ($data->deducaoReducao) {
            ...
            $this->appendElement(
                $vDedRed,
                'pDR',
                $data->deducaoReducao->percentualDeducaoReducao !== null
                ? number_format($data->deducaoReducao->percentualDeducaoReducao, 2, '.', '')
                : null
            );
            ...
            $this->appendElement(
                $vDedRed,
                'vDR',
                $data->deducaoReducao->valorDeducaoReducao !== null
                ? number_format($data->deducaoReducao->valorDeducaoReducao, 2, '.', '')
                : null
            );

            if (!empty($data->deducaoReducao->documentos)) {
                ...
                foreach ($data->deducaoReducao->documentos as $docData) {
                    ...
                    $this->appendElement(
                        $doc,
                        'vDedutivelRedutivel',
                        $docData->valorDedutivelRedutivel !== null
                        ? number_format($docData->valorDedutivelRedutivel, 2, '.', '')
                        : null
                    );
                    ...
                    $this->appendElement(
                        $doc,
                        'vDeducaoReducao',
                        $docData->valorDeducaoReducao !== null
                        ? number_format($docData->valorDeducaoReducao, 2, '.', '')
                        : null
                    );
        ...
        if ($data->tributacao) {
            ...
            $this->appendElement(
                $tribMun,
                'pAliq',
                $data->tributacao->aliquotaIssqn !== null
                ? number_format((float) $data->tributacao->aliquotaIssqn, 2, '.', '')
                : null
            );

            /*  $this->appendElement($tribMun, 'regApTribISSQN', $data->tributacao->regimeApuracaoTributoIssqn);
             */
            if ($data->tributacao->tipoImunidade !== null) {
            ...
            if ($data->tributacao->beneficioMunicipal) {
                ...
                $this->appendElement(
                    $bm,
                    'pRedBCBM',
                    $data->tributacao->beneficioMunicipal->percentualReducaoBcBm !== null
                    ? number_format($data->tributacao->beneficioMunicipal->percentualReducaoBcBm, 2, '.', '')
                    : null
                );
                ...
                $this->appendElement(
                    $bm,
                    'vRedBCBM',
                    $data->tributacao->beneficioMunicipal->valorReducaoBcBm !== null
                    ? number_format($data->tributacao->beneficioMunicipal->valorReducaoBcBm, 2, '.', '')
                    : null
                );
            ...
            $this->appendElement(
                $totTrib,
                'pTotTribSN',
                number_format($data->tributacao->percentualTotalTributosSN ?? 0, 2, '.', '')
            );
